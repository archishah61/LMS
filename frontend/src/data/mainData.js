...
const mainData = {
  introduction: {
    title: "Introduction",
    subtitle: "Embark on Your Journey with the Learnify E-Learning API",
    sections: [
      {
        title: "Welcome to the Learnify E-Learning Platform",
        content:
          "We are thrilled to welcome you to the Learnify E-Learning Platform, where innovation meets education. Our platform is designed to transform the landscape of online learning by offering a seamless, interactive, and comprehensive educational experience. Whether you are an educator looking to inspire, a developer aiming to integrate, or an administrator seeking to oversee, our platform provides the tools and flexibility to enhance the digital learning journey. With our robust suite of APIs, we empower you to create, manage, and analyze educational content with unparalleled ease and efficiency.",
      },
      {
        title: "Discover the Learnify Platform",
        content: "The Learnify platform is built on the principles of scalability and adaptability, featuring three core components that work in harmony to deliver an exceptional learning experience:",
        list: [
          {
            title: "Backend API",
