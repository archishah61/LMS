...
export default function GovernmentForm({ onSubmit, onBack }) {
  ...
  // Handle array fields like emails and mobile_numbers
  ...
  // Add a new field for emails or mobile numbers
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <h3 className="text-xl font-bold">Government Partner Form</h3>
