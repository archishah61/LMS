...
import { ArrowLeft, ShieldCheck, Lock, Clock, ChevronRight, Mail, ExternalLink } from 'lucide-react';
import { useNavigate, Link } from 'react-router-dom';

const PublicPrivacyPolicy = () => {
    const { data, isLoading } = useGetPrivacyPolicyByCategoryQuery("login");
                ...
                <div className="container mx-auto px-5 sm:px-6 lg:px-8 relative z-10">
                    <div className="max-w-3xl">
                        ...
                        <h1 className="text-3xl md:text-5xl font-extrabold text-white mb-6 leading-tight">
                            Privacy <span className="text-leafGreen">Policy</span>
                        </h1>
                        <p className="text-base md:text-lg text-gray-300 leading-relaxed">
                            Your privacy is our top priority. Learn how we collect, use, and protect your personal information to ensure a safe experience on our platform.
                        </p>
                    </div>
                </div>
            </section>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 md:gap-16">
                    ...
                    <div className="lg:col-span-8">
                        ...
                        <nav className="flex items-center gap-2 md:gap-3 text-[10px] font-bold uppercase tracking-widest text-gray-400 mb-8 overflow-hidden">
                            ...
                            <span className="text-leafGreen">Privacy Policy</span>
                        </nav>
                        ...
                        <div className="bg-white rounded-xl p-4 md:p-12 shadow-sm border border-gray-100 relative overflow-hidden">
                            ...
                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-2 mb-2 pb-2 border-b border-gray-50">
                                <div className="flex items-center gap-4">
                                    <div className="w-12 h-12 md:w-16 md:h-16 rounded-lg bg-lightGreen/20 flex items-center justify-center text-leafGreen">
                                        <Lock size={28} />
                                    </div>
                                    <div>
                                        <h2 className="text-xl md:text-2xl font-extrabold text-gray-900 leading-tight">Information Security</h2>
                            ...
                            {isLoading ? (
                                ...
                                <div className="prose prose-lg max-w-none">
                                    <div className="space-y-2">
                                        {activeSentences.map((html, index) => (
                                            <div 
                                                key={index} 
                                                className="group flex items-center gap-4 p-2 rounded-lg hover:bg-gray-50/50 transition-all border border-transparent hover:border-gray-100"
                                            >
                                                <div className="flex-shrink-0 w-8 h-8 md:w-10 md:h-10 rounded-full bg-lightGreen/10 flex items-center justify-center text-leafGreen font-bold text-xs md:text-sm">
                                                    {index + 1}
                                                </div>
                                                <div 
                                ...
                                <div className="text-center py-20 bg-gray-50 rounded-[32px] border border-dashed border-gray-200">
                                    ...
                                    <p className="text-gray-500 max-w-sm mx-auto leading-relaxed">
                                        We are currently updating our privacy policy to reflect our latest security standards.
                                    </p>
                                </div>
                            )}
                        </div>
                        ...
                        <div className="lg:sticky lg:top-32 space-y-10">
                            ...
                            <div className="p-8 bg-gray-50 rounded-xl border border-gray-100 shadow-sm">
                                ...
                                <div className="space-y-4">
                                    <Link to="/terms-of-service" className="flex items-center justify-between p-4 bg-white rounded-lg hover:bg-leafGreen/10 border border-gray-100">
                            ...
                            <div className="p-8 bg-forestGreen rounded-xl text-white relative overflow-hidden shadow-xl shadow-forestGreen/10">
                                ...
                                <h3 className="text-lg md:text-xl font-bold mb-4 relative z-10">Have Questions?</h3>
                                <p className="text-gray-300 text-xs md:text-sm mb-6 relative z-10 leading-relaxed">
                                    Our legal team is here to help if you need clarification on any of our policies.
                                </p>
                                <a 
                                ...
                                >
                                    <div className="w-12 h-12 rounded-lg bg-leafGreen flex items-center justify-center shadow-lg shadow-leafGreen/20">
                                        <Mail size={20} />
                                    </div>
                                    <div className="text-left overflow-hidden">
                                        <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-0.5">Reach out to us</p>
