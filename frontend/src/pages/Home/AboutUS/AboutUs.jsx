...
const AboutUs = () => {
    ...
    const testimonials = [
        {
            quote: "Learnify transformed my learning experience completely. The interactive courses and personalized learning paths helped me master skills I struggled with for years. The community of learners and instructors is incredibly supportive.",
            name: "Emily Rodriguez",
            role: "Data Science Student",
            image: "/assets/testimonial2.jpeg"
        },
        {
            quote: "As someone who struggled with traditional education, Learnify was a game-changer. The flexibility to learn at my own pace combined with the engaging content made learning enjoyable again. I've completed three certifications already!",
            name: "Michael Chen",
            role: "Web Development Student",
            image: "/assets/testimonial3.jpg"
        },
        {
            quote: "The personalized feedback from instructors is what sets Learnify apart. Every time I submitted a project, I received detailed guidance on how to improve. This level of attention has accelerated my growth tremendously.",
                                    ...
                                    <div className="flex items-start gap-2">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <p className="text-[10px] text-gray-600 leading-tight">
                                                Founded with a vision to make education accessible to everyone, Learnify started as a small team
                                ...
                                <div className="min-[320px]:hidden bg-white p-2 rounded border border-gray-100 shadow-sm hover:shadow-md transition-all duration-300">
                                    <div className="flex items-start gap-2">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <p className="text-[10px] text-gray-600 leading-tight">
                                               When the world needed online learning more than ever, Learnify scaled to meet the demand, introducing AI-powered learning paths and personalized education for learners of all ages.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="min-[320px]:hidden bg-white p-2 rounded border border-gray-100 shadow-sm hover:shadow-md transition-all duration-300">
                                    <div className="flex items-start gap-2">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <p className="text-[10px] text-gray-600 leading-tight">
                                                Today, Learnify stands as a leader in educational technology, continuously innovating
                    ...
                    <div className="flex flex-col lg:flex-row items-center">
                        <div className="lg:w-1/2 mb-6 sm:mb-8 md:mb-10 lg:mb-0 lg:pr-8 xl:pr-10 2xl:pr-12 text-center lg:text-left">
                            ...
                            <p className="text-xs sm:text-sm md:text-base opacity-90 mb-4 sm:mb-5 md:mb-6 px-2 sm:px-4 md:px-0">
                                Hear from our community of learners about how Learnify has transformed their educational experience.
                            </p>
                        </div>
