...
const FillInBlankQuestion = sequelize.define(
    "FillInBlankQuestion",
    {
        id: {
    ...
    {
        tableName: 'tbl_fill_in_blank_questions_gq', // Explicitly define table name
...
TextedBasedQuizText.hasMany(FillInBlankQuestion, { foreignKey: "quizTextId", onDelete: "CASCADE" });
FillInBlankQuestion.belongsTo(TextedBasedQuizText, { foreignKey: "quizTextId" });
